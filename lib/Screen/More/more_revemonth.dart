...
class ReveMonth extends StatefulWidget {
  DateTime dateTime;
  ReveMonth({Key? key,required this.dateTime}) : super(key: key);

  @override
  State<ReveMonth> createState() => _ReveMonthState();
}

class _ReveMonthState extends State<ReveMonth> {
      ...
      child: Scaffold(
        ...
        body:  Stack(
          children: [
            ...
            model.listmonth.isEmpty ? Container(
                ...
                children: [
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: model.listmonth.length,
                      itemBuilder:(context, index) {
                        var a = model.listmonth[index];
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      child: Text('Tháng ${a.date}',style: TextStyle(fontSize: 16),),
                                    ),
                                  ],
                                ),
                                Row(
                                ...
                                Row(
                                  children: [
                                    GestureDetector(
                                      onTap:(){
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => MoreMonth(month: a.date),));
                                      },
                                      child: Container(
