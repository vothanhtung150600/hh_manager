...
class ReveDay extends StatefulWidget {
  ReveDay({Key? key}) : super(key: key);

  @override
  State<ReveDay> createState() => _ReveMonthState();
}

class _ReveMonthState extends State<ReveDay> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Doanh thu các ngày trước',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.pinkAccent),),
        ),
        body:  Stack(
          children: [
            Container(
            ...
            model.listmoney.isEmpty ? Container(
                alignment: Alignment.center,
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    JumpingText('Chưa có doanh thu cho ngày này....',style: TextStyle(color: Colors.pinkAccent,fontSize: 18),)
                  ],
                )) :
                ...
                children: [
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: model.reveday().length,
                      itemBuilder:(context, index) {
                        var a = model.reveday()[index];
